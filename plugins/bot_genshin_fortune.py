...
def drawing(model, userQQ):
    ...
    if model == GenshinFortuneModel.KURE:
        imgPath = f'{RESOURCES_BASE_PATH}/img/frame_{GenshinFortuneModel.KURE.value}.jpg'
    # kokusei
    if model == GenshinFortuneModel.KOKUSEI:
        imgPath = f'{RESOURCES_BASE_PATH}/img/frame_{GenshinFortuneModel.KOKUSEI.value}.jpg'
    # dirukku
    if model == GenshinFortuneModel.DIRUKKU:
        imgPath = f'{RESOURCES_BASE_PATH}/img/frame_{GenshinFortuneModel.DIRUKKU.value}.jpg'
    # babara
    if model == GenshinFortuneModel.BABARA:
        imgPath = f'{RESOURCES_BASE_PATH}/img/frame_{GenshinFortuneModel.BABARA.value}.jpg'
    # nana
    if model == GenshinFortuneModel.NANA:
        imgPath = f'{RESOURCES_BASE_PATH}/img/frame_{GenshinFortuneModel.NANA.value}.jpg'
